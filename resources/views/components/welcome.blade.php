<div class="p-2">
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
            ...
            <p class="mt-2 text-sm leading-6 text-gray-500">
                Submit a new purchasing request for your team.
            </p>
        ...
        @if(auth()->user()->hasRole(['supervisor', 'team-leader']))
            <a href="" class="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-amber-200 hover:shadow-md" > 
                <div class="`flex h-11 w-11 items-center justify-center rounded-xl bg-amber-50"> 
                ...
                <h2 class="mt-5 text-lg font-semibold text-gray-900"> Requests to Review </h2> 
                <p class="mt-2 text-sm leading-6 text-gray-500"> Review purchasing requests that are waiting for your action. </p> 
                <div class="mt-5 flex items-center justify-between"> 
                    <span class="text-sm font-semibold text-amber-600"> Review requests <span class="transition group-hover:ml-1">→</span> </span> {{-- Pending count --}} <span class="inline-flex min-w-7 items-center justify-center rounded-full bg-amber-100 px-2 py-1 text-xs font-bold text-amber-700" > 3 </span> 
                </div> 
            </a>
            <a
                href=""
